<?php
	...
	if (empty($_POST['nombre_empresa'])) {
        ...
        }else if (empty($_POST['nit_empresa'])) {
		...
		$sql="UPDATE perfil SET nombre_empresa='".$nombre_empresa."', nit_empresa='".$nit_empresa."', telefono='".$telefono."', email='".$email."', direccion='".$direccion."', ciudad='".$ciudad."', estado='".$estado."', codigo_postal='$codigo_postal' WHERE id_perfil='1'";
